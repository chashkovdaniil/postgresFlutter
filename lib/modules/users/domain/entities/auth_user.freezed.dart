...
class _$AuthUserTearOff {
  ...
  _AuthUser call({required String email, required String password}) {
    return _AuthUser(
      email: email,
      password: password,
    );
...
class _$_AuthUser implements _AuthUser {
  const _$_AuthUser({required this.email, required this.password});
...
abstract class _AuthUser implements AuthUser {
  const factory _AuthUser({required String email, required String password}) =
      _$_AuthUser;
